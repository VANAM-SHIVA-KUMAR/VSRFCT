...
const founders = [
  {
    ...
    bio: [
      ...
      "His passion is institution building and educating the children of the economically weaker sections of society."
    ]
  }
];
    ...
    <div ref={ref} className="grid md:grid-cols-12 gap-8 md:gap-12 items-center">
      ...
      >
        ...
        {founder.bio.map((paragraph, pIndex) => (
          <p key={pIndex} className="text-white mb-4 whitespace-pre-line">
            {paragraph}
          </p>
        ))}
      </div>
    ...
    <section id="about" className="py-12 md:py-24 bg-card">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg italic md:text-xl text-white/70 mt-4 max-w-3xl mx-auto">
