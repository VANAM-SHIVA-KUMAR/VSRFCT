...
const teamMembers = [
  ...
  { name: "Mrs. Y. S. Madhuri", role: "Primary Classes Teacher", image: "/images/Team/Madhuri.jpeg", hint: "professional male administrator", description: "Mrs. Y. S. Madhuri has a Degree. She is working with us since December, 2022." },
